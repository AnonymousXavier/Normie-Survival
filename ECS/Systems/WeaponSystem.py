from ECS.Components import PowerUpTag, SpacialComponent, RotationComponent, CooldownComponent, ArsenalComponent
...
def process(world: dict, spatial_grid: dict, delta: float):
    ...
    for obj in list(world.values()):
        if PowerUpTag in obj and CooldownComponent in obj:
            ...
            obj[CooldownComponent].fire_rate = shotgun_stats.fire_rate
            ...
            if obj[CooldownComponent].time_since_last_shot >= obj[CooldownComponent].fire_rate:
                ...
                for angle in angles:
                    Factories.spawn_bullet(world, spatial_grid, cx, cy, angle, shotgun_stats.speed, shotgun_stats.damage)